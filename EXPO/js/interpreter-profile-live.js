document.addEventListener('DOMContentLoaded',async()=>{
 ...
 const section=document.createElement('section');section.style.cssText='padding:24px;margin:24px;background:#fff;border-radius:20px;color:#1e293b';
 ...
 const label=document.createElement('label');label.textContent='Upload your certification for review (PDF, JPG or PNG; up to 5 MB)';const input=document.createElement('input');input.type='file';input.accept='.pdf,.jpg,.jpeg,.png';label.append(input);section.append(label);
